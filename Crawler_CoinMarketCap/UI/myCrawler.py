...
def initurllist(name,start_date,end_date):
    crypto_dict = {}
    crypto_dict[str(name)] = "https://coinmarketcap.com/currencies/"+str(name)+"/historical-data/?start="+start_date+"&end="+end_date
